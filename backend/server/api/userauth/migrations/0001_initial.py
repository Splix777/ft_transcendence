    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('login', models.CharField(blank=True, default=None, max_length=100, null=True)),
                ...
                ('list_of_sent_invites', models.JSONField(blank=True, default=list)),
                ('list_of_received_invites', models.JSONField(blank=True, default=list)),
